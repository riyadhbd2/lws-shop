...
const Header = ({ searchTerm, onSearch }) => {
  ...
  const cartItemCount = cartData.reduce((total, item) => total + item.qty, 0);
      ...
      <div className="container mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          ...
          >
            ...
            {cartItemCount > 0 && (
              <div className="absolute right-0 top-[-4px] bg-red-600 text-white rounded-full px-[5px] text-xs py-[1px] min-w-[18px] text-center">
                {cartItemCount}
              </div>
            )}
          </a>
